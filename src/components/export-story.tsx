...
export function ExportStory({
  ...
  return (
    <div className="relative flex h-full w-full overflow-hidden rounded-[42px] bg-[linear-gradient(180deg,#07111e_0%,#0d1930_34%,#091422_100%)] text-white">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(82,163,255,0.18),transparent_24%),radial-gradient(circle_at_bottom_right,rgba(251,191,36,0.18),transparent_24%)]" />

      <div className="relative flex w-[30%] flex-col border-r border-white/10 bg-[linear-gradient(180deg,rgba(6,15,28,0.9),rgba(7,11,18,0.76))] px-8 py-9">
        <p className="text-[18px] font-semibold uppercase tracking-[0.4em] text-[#f5dfa0]">
          Matchkort
        </p>
        <h1 className="mt-4 text-6xl font-black uppercase leading-none tracking-[0.08em]">
          Start 9
        </h1>
        ...
        <div className="mt-8 rounded-[28px] border border-white/10 bg-white/6 p-5 shadow-[0_24px_54px_rgba(3,7,18,0.36)]">
          <p className="text-[11px] uppercase tracking-[0.34em] text-[#f5dfa0]/72">
            Matchdetaljer
          </p>
          <p className="mt-3 text-3xl font-black uppercase">{match.opponentName}</p>
          <p className="mt-3 text-lg text-white/72">{match.location}</p>
      ...
      <div className="relative flex flex-1 flex-col px-8 py-9">
        ...
        <div className="relative flex-1 overflow-hidden rounded-[34px] border border-white/10 bg-[linear-gradient(180deg,#111f35_0%,#0b1625_100%)] shadow-[0_28px_70px_rgba(3,7,18,0.34)]">
          <div className="absolute inset-x-[6%] bottom-[8%] top-[16%] overflow-hidden [clip-path:polygon(9%_0,91%_0,100%_100%,0_100%)] rounded-[24px] bg-[linear-gradient(180deg,#5bac31_0%,#4a9e2a_18%,#408422_100%)]">
            ...
            <div className="absolute inset-0 bg-[linear-gradient(90deg,transparent_49.6%,rgba(255,255,255,0.8)_49.6%,rgba(255,255,255,0.8)_50.4%,transparent_50.4%)]" />
